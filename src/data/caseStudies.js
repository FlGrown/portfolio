const caseStudies = [
  {
    ...
    meta: [
      { label: 'Company', value: 'Capital Rx — Healthtech SaaS, Pharmacy Benefits Management' },
      { label: 'Timeline', value: '2021 – Present' },
      { label: 'My Role', value: 'Key Frontend Contributor on Cross-Functional Squad' },
      { label: 'Tech Stack', value: 'React · TypeScript · React-Query · Sass · AWS Lambda' },
    ],
    sections: [
      {
        type: 'text',
      ...
      },
      {
        ...
        intro: 'As a key contributor on the frontend squad, I worked across the full claims adjudication UI, architecting and building complex flows that handled large volumes of structured medical data while remaining intuitive for non-technical clinical users.',
        items: [
  ...
  },
  {
    ...
    meta: [
      ...
      { label: 'My Role', value: 'Lead Frontend Engineer — Full Architecture & Implementation Ownership' },
      { label: 'Tech Stack', value: 'React · TypeScript · React-Query · REST APIs' },
    ],
    sections: [
      {
        type: 'text',
      ...
      },
      {
        type: 'bullets',
        title: 'My Approach',
        intro: 'After auditing the existing codebase, the root cause was clear: no coherent data-fetching strategy. Components were independently firing API calls with no shared caching layer. I proposed and drove the adoption of React-Query as the foundation for the rebuild.',
        items: [
  ...
  },
  {
    ...
    meta: [
      { label: 'Company', value: 'Capital Rx — Healthtech SaaS, Pharmacy Benefits Management' },
      { label: 'Timeline', value: '2022 – 2023' },
      { label: 'My Role', value: 'Frontend Lead — Implementation & Accessibility Strategy (partnered with Designer)' },
    ...
    sections: [
      ...
      },
      {
        type: 'bullets',
        title: 'My Approach',
        intro: 'The designer defined visual and interaction specifications; I owned the technical implementation and accessibility engineering.',
        items: [
